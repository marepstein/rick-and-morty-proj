    ...
    return (
        <CharacterContainer>
            ...
            <><CharacterHeadSection>
                    ...
                    <CharacterInfoContainer>
                ...
                </CharacterHeadSection><CharacterInfoSection>
                        ...
                        <CharacterInfoText>
                            First Appearance: {firstEpisode?.name}{' '}
                            {firstEpisode?.episode}
                        </CharacterInfoText>
                        <CharacterInfoText>
                            First Appearance Air date: {firstEpisode?.airDate}
                        </CharacterInfoText>
                        <CharacterInfoText>
                            First Appearance Character Count:{' '}
                            {firstEpisode?.noOfCharacters}
                        </CharacterInfoText>
                        <CharacterInfoText>
                            Last Appearance: {lastEpisode?.name} {lastEpisode?.episode}
                        </CharacterInfoText>
                        <CharacterInfoText>
                            Last Appearance Air date: {lastEpisode?.airDate}
                        </CharacterInfoText>
                        <CharacterInfoText>
                            Last Appearance Character Count:{' '}
                            {lastEpisode?.noOfCharacters}
                        </CharacterInfoText>
                    </CharacterInfoSection></>}
        </CharacterContainer>
    )
